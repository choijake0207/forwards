...
export default function ProgressWidget({toggleForm, updatedHabits, handleWindowChange, handleDecrement, handleIncrement, formattedWindow}) {
            ...
            {windowTypes.map(type => {
              return (
                <button 
                  ...
                  key={type}
                  onClick={() => handleWindowChange(type)}
                >
                  {type}
                </button>
              )
